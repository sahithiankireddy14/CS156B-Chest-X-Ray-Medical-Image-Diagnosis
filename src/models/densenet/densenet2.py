...
PRINT_FREQ = 5000
EPOCHS = 10
OUTPUT_NAME = 'predicted_effusion_train.csv'
CHECKPOINT_NAME = 'model_effusion_train.h5'
COL = 12
...
with open(OUTPUT_NAME, 'w', newline='') as csvfile:
    ...
    for i in range(len(testid)):
        spamwriter.writerow([testid[i],testpath[i],-1,0,0,1,0,least_mse(predicted[i]),1,0,1])
